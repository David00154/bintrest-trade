...
router
  ...
  .get(forwardAuthenticated, (req, res) => {
    res.render("login", { title: "Log in - Tetra Fx" });
  })
  .post(login);
...
router
  .route("/signup")
  .get((req, res) => {
    res.render("signup", { title: "Sign up - Tetra Fx" });
  })
  .post(
    validateSignupFields,
    validateErrors,
...
// 	res.render("reset-password-page", { title: "Sign up - Tetra Fx", level: 2 });
